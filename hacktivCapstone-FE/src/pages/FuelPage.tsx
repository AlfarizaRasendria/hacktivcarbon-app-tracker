...
import FuelEstimationForm from '../components/FuelEstimationData';
import type { FuelEstimationData } from '../components/FuelEstimationData';
...
const FuelPage = () => {
  ...
  const handleSubmit = async (data: FuelEstimationData): Promise <void> => {
  setLoading(true);
  setError(null);
  setCarbonData(null);
  ...
  return (
    <DashboardLayout>
      <div className="p-4" style={{ flex: 1 }}>
        <h3>Fuel Combustion Estimation</h3>
        <FuelEstimationForm onSubmit={handleSubmit} />
      </div>
